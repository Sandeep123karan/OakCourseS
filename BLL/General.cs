...
namespace BLL
{
    public static class General
    {
        public static class ProcessType
        {
            ...
            public static int VideoAdd = 2;
            public static int VideoUpdate = 2;
            public static int VideoDelete = 2;
            public static int PostAdd= 2;
            public static int PostUpdate = 2;
            public static int PostDelete = 2;
            public static int ImageAdd = 2;
            public static int ImageUpdate = 2;
            public static int ImageDelete = 2;
            public static int TagAdd = 2;
            public static int TagUpdate = 2;
            public static int TagDelete = 2;
            public static int CommentApprove = 2;
            public static int CommentDelete = 2;
            public static int ContactRead = 2;
            public static int ContactDelete = 2;
